package com.abin.lee.im.websocket;

import com.abin.lee.im.websocket.filter.NettyHttpServerFilter;
 ...
 */
public class ImNettyHttpServer {
    ...
    public static void main(String[] args) throws InterruptedException {
        try {
            ...
            b.childHandler(new NettyHttpServerFilter()); //设置过滤器
            // 服务器绑定端口监听
